...
@Route(value = "", layout = PrincipalLayout.class)
@PageTitle("Games")
//@CssImport("./styles/layout.css")
@AnonymousAllowed
public class PrincipalGameView  extends VerticalLayout {
    ...
    public PrincipalGameView(@Autowired GameController gameController, @Autowired StateStorageService stateStorageService) throws DefaultException {
    ...
    private void navigateToReviews(Long gameId) {
        ...
        getUI().ifPresent(ui -> ui.navigate("reviews"));
    }
